...
import sty from './PlasmicTextInput.module.css'; // plasmic-import: eUvFTpTI4dJJVg/css
...
export type PlasmicTextInput__VariantsArgs = {
  ...
  numeric?: SingleBooleanChoiceArg<'numeric'>;
  ...
  const stateSpecs = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: 'private',
        variableType: 'variant',
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.numeric,
      },
  ...
  return (
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootborderless]: hasVariant($state, 'borderless', 'borderless'),
          [sty.rootcolor_dark]: hasVariant($state, 'color', 'dark'),
          [sty.rootisDisabled]: hasVariant($state, 'isDisabled', 'isDisabled'),
          [sty.rootnumeric]: hasVariant($state, 'numeric', 'numeric'),
    ...
    >
      {(hasVariant($state, 'showStartIcon', 'showStartIcon') ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: <SearchsvgIcon className={classNames(projectcss.all, sty.svg__a3IDg)} role={'img'} />,
      ...
      <input
        ...
        className={classNames(projectcss.all, projectcss.input, sty.input, {
          ...
          [sty.inputborderless]: hasVariant($state, 'borderless', 'borderless'),
          [sty.inputcolor_dark]: hasVariant($state, 'color', 'dark'),
          [sty.inputisDisabled]: hasVariant($state, 'isDisabled', 'isDisabled'),
          [sty.inputnumeric]: hasVariant($state, 'numeric', 'numeric'),
        ...
        type={hasVariant($state, 'numeric', 'numeric') ? ('number' as const) : ('text' as const)}
        value={args.value}
      ...
      {true ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: <ChecksvgIcon className={classNames(projectcss.all, sty.svg__bhmpj)} role={'img'} />,
