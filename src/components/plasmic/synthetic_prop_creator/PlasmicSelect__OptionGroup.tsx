...
import sty from './PlasmicSelect__OptionGroup.module.css'; // plasmic-import: jn3tiZJi2jCL9/css

import SUPER__PlasmicSelect from './PlasmicSelect'; // plasmic-import: R93O6qtnoGgKV/render
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option className={classNames('__wab_instance', sty.option__rGZeu)} />

              <Select__Option className={classNames('__wab_instance', sty.option__ggbyT)} />
            </React.Fragment>
          ),
          value: args.children,
        })}
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
  ...
  const func = function <T extends PropsType>(props: T & StrictProps<T, PropsType>) {
    ...
    return PlasmicSelect__OptionGroup__RenderFunc({ variants, args, overrides, forNode: nodeName });
  };
  if (nodeName === 'root') {
