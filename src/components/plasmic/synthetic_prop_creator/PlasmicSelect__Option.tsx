...
import sty from './PlasmicSelect__Option.module.css'; // plasmic-import: wfKz4k2V_x8Tz/css

import Icon2Icon from './icons/PlasmicIcon__Icon2'; // plasmic-import: Iidz4fiYFzaCx2/icon
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
  ...
  const func = function <T extends PropsType>(props: T & StrictProps<T, PropsType>) {
    ...
    return PlasmicSelect__Option__RenderFunc({ variants, args, overrides, forNode: nodeName });
  };
  if (nodeName === 'root') {
